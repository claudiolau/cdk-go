...
func NewCdkGoStack(scope constructs.Construct, id string, props *CdkGoStackProps) awscdk.Stack {
	...
	myFunction := awslambda.NewFunction(stack, jsii.String("myLambdaFunction"), &awslambda.FunctionProps{
		...
		Code:    awslambda.AssetImageCode_FromAsset(jsii.String("lambda/function.zip"), nil),
	...
	// Define the routes
	registerResources := api.Root().AddResource(jsii.String("register"), nil)
	registerResources.AddMethod(jsii.String("POST"), integration, nil)
